...
# histogram((freqs+10**-6.5).log10(), histnorm="percent", title="Frequencies for Final Checkpoint")
...
fig = histogram(to_numpy(freqs), histnorm="percent", marginal="box", title="Cosine sim of rare features with mean rare direction")
# Specify the directory where you want to save the image
save_dir = "/workspace/1L-Sparse-Autoencoder/hist_folder"  # Replace this with your desired path
os.makedirs(save_dir, exist_ok=True)  # Create the directory if it doesn't exist

# Save the figure as a PNG file
file_path = os.path.join(save_dir, "cosine_sim_histogram.png")
